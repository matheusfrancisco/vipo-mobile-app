...
import { ContainerTitle, ContainerDescription, BoxBorder, ContainerBenefits, Container } from './styles';
      ...
      <ScrollView>
        <Container>
          ...
          <ContainerDescription>
            <Title3>
              Aproveite os benefícios indo pela Vipo.
            </Title3>     
          </ContainerDescription>
